...
#define NODE_MAIN_LOGGER_NAME "livox_ros2_driver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblivox_ros2_driver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<livox_ros::LivoxDriver>";
